...
class AdminLocationController extends AbstractController
{
    ...
    public function new(Request $request, LocationRepository $locationRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'La position à bien été enregistrée');

            return $this->redirectToRoute('app_location_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('admin_location/new.html.twig', [
            'location' => $location,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Location $location, LocationRepository $locationRepository): Response
    {
        ...
        return $this->render('admin_location/edit.html.twig', [
            'location' => $location,
            'form' => $form,
        ]);
    }
    ...
    public function delete(Request $request, Location $location, LocationRepository $locationRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$location->getId(), $request->request->get('_token'))) {
            ...
            $this->addFlash('danger', 'La position à bien été supprimée');
        }
